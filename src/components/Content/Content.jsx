        ...
        <section className="inicio" id="inicio">
            ...
            <div className="titulo">
                ...
                <h1 data-aos="fade-up" data-aos-delay="800">
                    <FormattedMessage
                        id='name'
                        defaultMessage='I am Lucas Ferreyra'
                    />
                </h1>
                ...
                <div className="wrapper">
                    ...
                    <a className="button" href="https://github.com/Lucasdeep10/" target="_blank" rel="noopener noreferrer" data-aos="fade-up" data-aos-delay="1400">
                        <div className="icon">
                            <i className="fab fa-github"></i>
                        </div>
                        <span>Github</span>
                    </a>
                    <a className="button" href="https://www.instagram.com/lucasferreyra8/" target="_blank" rel="noopener noreferrer" data-aos="fade-up" data-aos-delay="1600">
                        <div className="icon">
